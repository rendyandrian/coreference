    ...
    <link href="{{ assets_url("") }}vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
    <link rel="stylesheet" href="{{ assets_url("css/bootstrap-select.css") }}">
    ...
    <link href="{{ assets_url("css/alert/sweetalert.css") }}" rel="stylesheet">
