...
@section('content')
	<div class="container-fluid" >
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">Tambah Jadwal Sprin</h1>
		</div>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="table-responsive" style="overflow-x:hidden;">
					@php
					echo form_open('sprint', array('class' => 'form', 'id' => 'add'));
					@endphp
						<table class="table">
							<tr>
								<td>Sprin</td>
								<td>
								<input type="text" name="sprint_name" id="sprint_name" placeholder="Masukkan Nama Sprin" class="form-control" value="{{set_value('sprint_name')}}" required>
								</td>
							</tr>
							<tr>
								...
								<input type="hidden" name="page_accessed" value ="add_sprint">
							...
							<tr>
								<td>Lokasi</td>
								<td>
								<input type="text" name="lokasi" id="lokasi" placeholder="Masukkan Lokasi Sprin" class="form-control" value="{{set_value('lokasi')}}" required>
								</td>
							</tr>
												...
												<tr>
													...
													<td>	
														<div class="form-inline">
															...
															<input type="text" class="nrp{{$key+1}} form-control" value="{{$item}}" name="additional[peserta][]" placeholder='Masukkan NRP Anda' min='0' hidden>
