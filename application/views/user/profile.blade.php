		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="table-responsive">
					...
					@endphp
						<table class="table">
							<input type="text" value="profile" name="page_user" hidden>
							<tr>
								...
								<td>
									...
									<a href="#" onclick="getPersonelByNRPForAddUser()" id="loading" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin:0px 10px;"><i class="fas fa-check fa-sm text-white-50"></i> Update Data NRP</i></a>
									</div>
								</td>
							</tr>
							<tr>
