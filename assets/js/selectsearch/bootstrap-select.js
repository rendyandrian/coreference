  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '</div>'
          : '';
      var drop =
          '<div class="btn-group bootstrap-select' + showTick + inputGroup + '" style="padding:0px; margin:0px; ">' +
          '<button type="button" style="background:#fff;  border:#ccc thin solid; " class="' + this.options.styleBase + ' dropdown-toggle" data-toggle="dropdown"' + autofocus + ' role="button" aria-labelledby="'+this.$element.attr("aria-labelledby")+'">' +
